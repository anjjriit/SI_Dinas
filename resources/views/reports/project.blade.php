                                ...
                                <table class="table" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                {{ $activity->project->nama_lembaga }}
                                            </td>
                                            <td>
                                                @if (isset($biayaProject[$activity->kode_kegiatan]))
                                                    Rp {{ number_format($biayaProject[$activity->kode_kegiatan], 0, ',', '.') }}
                                                @else
                                                    Rp 0
                                                @endif
                                            </td>
                                        ...
                                        <tr style="background-color: #fafafa;">
                                            ...
                                            <td>Rp {{ number_format(array_sum($biayaProject), 0, ',', '.') }}</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
