...
<head>
    ...
    <style>
        ...
        body { font-size: 14px; padding: 20px 30px;} .table { font-size: 14px; } .table-bordered th, .table-bordered td { padding: 2px 4px;border: 1px solid #999;} th { text-align: left; } .kop { border-bottom: 3px double #999;margin-bottom: 30px;}
    </style>
</head>
<body>
